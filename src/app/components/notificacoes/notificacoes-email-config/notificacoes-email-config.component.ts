...
import { NotificacaoEmailService, NotificacaoEmailConfig } from '@services/notificacao-email.service';
...
@Component({
    ...
    standalone: true,
    imports: [...SALVE_COMMON, ...SALVE_FORMS, ...SALVE_DATA, ...SALVE_OVERLAY, InfoBlockComponent]
})
